...
public class One extends Fragment {
    ...
    public void getData(){
        ...
        OkHttpUtils.post().url(Contants.API.WARES_CAMPAIN_LIST).addParams("campaignId", id).addParams("orderBy", "0").addParams("curPage", "1").addParams("pageSize", "20").build().execute(new StringCallback(){
            @Override
