...
public class Two extends Fragment{
    ...
    private String id;
    public  int ACTION_LIST = 1;
    public  int ACTION_GIRD = 2;
        ...
        change.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(ACTION_LIST==action){
                    ...
                    change.setImageDrawable(getResources().getDrawable(R.mipmap.draw));
                    recyclerView.setLayoutManager(new WrapContentLinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
                    recyclerView.setAdapter(newAdapter);
                }if(ACTION_GIRD==action){
                    change.setTag(ACTION_LIST);
                    change.setImageResource(R.mipmap.draw);
                    change.setImageDrawable(getResources().getDrawable(R.mipmap.san));
    ...
    public void getData(){
        ...
        OkHttpUtils.post().url(Contants.API.WARES_CAMPAIN_LIST).addParams("campaignId", id).addParams("orderBy", "2").addParams("curPage", "1").addParams("pageSize", "20").build().execute(new StringCallback(){
            @Override
